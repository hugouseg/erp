...
class RentalContract extends BaseModel
{
    ...
    public function rentalPeriod(): BelongsTo { return $this->belongsTo(RentalPeriod::class); }
    public function invoices(): HasMany { return $this->hasMany(RentalInvoice::class, 'contract_id'); }
    public function payments(): HasMany { return $this->hasMany(RentalPayment::class, 'contract_id'); }
