...
use App\Http\Requests\PosResumeRequest;
...
class PosController extends Controller
{
    ...
    public function resume(Request $request)
    {
        ...
        if (!$data) return $this->fail(__('Hold not found'), 404);
    ...
    public function reprint(int $sale){ return $this->ok(app(\App\Services\Contracts\SaleServiceInterface::class)->printInvoice($sale)); }
    public function xReport(){ return $this->ok(['report'=>'X']); }
    public function zReport(){ return $this->ok(['report'=>'Z']); }
}
