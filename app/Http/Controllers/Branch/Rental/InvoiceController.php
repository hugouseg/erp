...
class InvoiceController extends Controller
{
    ...
    public function show(RentalInvoice $invoice){ return $this->ok($invoice); }

    public function runRecurring(){ return $this->ok(['queued'=>$this->rental->runRecurring()], __('Run recurring')); }
